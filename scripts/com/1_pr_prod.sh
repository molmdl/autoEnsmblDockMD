...
LIGAND_PATTERN="$(get_config production ligand_pattern "$(get_config complex ligand_pattern "lig*")")"
LIGAND_LIST_CFG="$(get_config production ligand_list "$(get_config complex ligand_list "")")"
...
NTOMP="$(get_config production ntomp "$(get_config slurm ntomp "8")")"
SLURM_PARTITION="$(get_config production partition "$(get_config slurm partition "rtx4090")")"
SLURM_GPUS="$(get_config production gpus "$(get_config slurm gpus "1")")"
