/gsd-map-codebase
after codebase scanning, spawn additional subagents for the additional tasks, output each report into timestamped file in .planning/code_analysis. do not fix yet, I will start new debug session or urgent phase insertion or quick task for the fix.
A. for all the codes in this repo, critically scan the code and trace the logic of different options to identift vunlability, suspecious code, or issues leading to safy concerns or performance lost. do not run anything.
